...
import { ServiceMacAccountHolderPayloadGenerator } from "../../../../support/payload_generators/service_mac/service_mac_account_holder_payload_generator";
...
describe('API Tests: SERVICE_MAC', function() {
    ...
    it('Post Account Holder [200]: post valid account holder',() => {
        ...
        const loan_number = serviceMacApi.cypressEnv.loan_number
        let payload = serviceMacAccountHolder.generateData(loan_number)
